...
namespace Database_Project {
    ...
    public partial class LibraryDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public BooksRow AddBooksRow(string TITLE, string AUTHOR, int YearPublished, string GENRE) {
...
namespace Database_Project.LibraryDBDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([ID] = @Original_ID) AND ([TITLE] = @Original_T" +
                "ITLE) AND ([AUTHOR] = @Original_AUTHOR) AND ([YearPublished] = @Original_YearPub" +
                "lished) AND ([GENRE] = @Original_GENRE))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([TITLE], [AUTHOR], [YearPublished], [GENRE]) VALUES (@" +
                "TITLE, @AUTHOR, @YearPublished, @GENRE);\r\nSELECT ID, TITLE, AUTHOR, YearPublishe" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [TITLE] = @TITLE, [AUTHOR] = @AUTHOR, [YearPublished] = @YearPublished, [GENRE] = @GENRE WHERE (([ID] = @Original_ID) AND ([TITLE] = @Original_TITLE) AND ([AUTHOR] = @Original_AUTHOR) AND ([YearPublished] = @Original_YearPublished) AND ([GENRE] = @Original_GENRE));
SELECT ID, TITLE, AUTHOR, YearPublished, GENRE FROM Books WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Database_Project.Properties.Settings.Default.LibraryDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, TITLE, AUTHOR, YearPublished, GENRE FROM dbo.Books";
        ...
        public virtual int Delete(int Original_ID, string Original_TITLE, string Original_AUTHOR, int Original_YearPublished, string Original_GENRE) {
        ...
        public virtual int Insert(string TITLE, string AUTHOR, int YearPublished, string GENRE) {
            if ((TITLE == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(YearPublished));
            if ((GENRE == null)) {
        ...
        public virtual int Update(string TITLE, string AUTHOR, int YearPublished, string GENRE, int Original_ID, string Original_TITLE, string Original_AUTHOR, int Original_YearPublished, string Original_GENRE, int ID) {
            if ((TITLE == null)) {
                throw new global::System.ArgumentNullException("TITLE");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(YearPublished));
            if ((GENRE == null)) {
                throw new global::System.ArgumentNullException("GENRE");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_YearPublished));
            if ((Original_GENRE == null)) {
                throw new global::System.ArgumentNullException("Original_GENRE");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TITLE, string AUTHOR, int YearPublished, string GENRE, int Original_ID, string Original_TITLE, string Original_AUTHOR, int Original_YearPublished, string Original_GENRE) {
            return this.Update(TITLE, AUTHOR, YearPublished, GENRE, Original_ID, Original_TITLE, Original_AUTHOR, Original_YearPublished, Original_GENRE, Original_ID);
        }
    }
